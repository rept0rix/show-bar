...
<!-- showbar:download -->
Show Bar is for macOS 14 or later. The install disk is [Show Bar 1.8](https://github.com/rept0rix/show-bar/releases/download/v1.8.0/Show-Bar-1.8.dmg). Open it and drag Show Bar into Applications.
<!-- /showbar:download -->
