...
<!-- showbar:download -->
Show Bar is for macOS 14 or later. The install disk is [Show Bar 1.4](https://github.com/rept0rix/show-bar/releases/download/v1.4.0/Show-Bar-1.4.dmg). Open it and drag Show Bar into Applications.
<!-- /showbar:download -->
